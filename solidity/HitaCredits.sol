...
contract HitaCredits is ERC20, Ownable {
    
    mapping(address => bool) public blacklist;

    constructor() ERC20("Hita Credits", "HTCRD") Ownable(msg.sender) {
    }
   ...
   function setBlacklist(address[] memory accounts, bool flag) external onlyOwner {
